<?php
    ...
    $sql = "SELECT sps AS SPs, lit AS LIT, leads AS 'TC Leads', yearlong AS Yearlong, meeting, programming, mandatory, total
            FROM counselors
            WHERE id = $id;";
    ...
    foreach ($row as $key => $value){
        if ($value !== null && $key !== 'total' && $key != 'programming' && $key != 'mandatory' && $key !== 'meeting'){
...
<head>
    ...
    <meta name="description" content="View your detailed consistency scores, including total, mandatory, programming, meetings, and specific enrolled programs.">
...
<body>
    ...
    <h1>Consistency Score Breakdown</h1>
                    ...
                    <table>
                        <?php if ($meeting_result->num_rows == 0) : ?>
                            <tr class="text-center">
                                <td>
                                    <?php echo "You completed all your commitments for this programming!"; ?>
                                </td>
                            </tr>
                        <?php endif; ?>
            ...
            <?php foreach ($programmings as $key => $value) : ?>
                <div class="carousel-item">
                    ...
                    <div class="breakdown">
                        ...
                        <table>
                            <?php if ($point_breakdowns[$key]->num_rows == 0) : ?>
                                <tr class="text-center">
                                    <td>
                                        <?php echo "You completed all your commitments for this programming!"; ?> 
                                    </td>
